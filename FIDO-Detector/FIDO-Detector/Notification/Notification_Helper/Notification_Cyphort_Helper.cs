...
namespace Fido_Main.Notification.Notification_Helper
{
  static class Notification_Cyphort_Helper
  {
    ...
    {
      if ((lFidoReturnValues.Cyphort.ThreatGRID != null) && (lFidoReturnValues.Cyphort.ThreatGRID.ThreatScore > 0))
      {
      ...
      if ((lFidoReturnValues.Cyphort.ThreatGRID != null) && (lFidoReturnValues.Cyphort.ThreatGRID.ThreatSeverity > 0))
      {
        if ((lFidoReturnValues.Cyphort.ThreatGRID.IPThreatInfo != null) && (lFidoReturnValues.Cyphort.ThreatGRID.IPThreatInfo.Count > 0))
        {
      ...
      if ((lFidoReturnValues.Cyphort.ThreatGRID != null) && (lFidoReturnValues.Cyphort.ThreatGRID.ThreatConfidence > 0))
      {
        if ((lFidoReturnValues.Cyphort.ThreatGRID.IPThreatInfo != null) && (lFidoReturnValues.Cyphort.ThreatGRID.IPThreatInfo.Count > 0))
        {
          //todo: move this to the DB
      ...
      if ((lFidoReturnValues.Cyphort.ThreatGRID != null) && (lFidoReturnValues.Cyphort.ThreatGRID.ThreatIndicators > 0))
      {
        if ((lFidoReturnValues.Cyphort.ThreatGRID.IPThreatInfo != null) && (lFidoReturnValues.Cyphort.ThreatGRID.IPThreatInfo.Count > 0))
        {
          //todo: move this to the DB
    ...
    {
      if (lFidoReturnValues.Cyphort.ThreatGRID == null) return replacements;
