...
namespace Fido_Main.Notification.Notification_Helper
{
  ...
  {
    public static Dictionary<string, string> StartReplacements(FidoReturnValues lFidoReturnValues, List<string> lBadMD5Hashes, List<string> lGoodMD5Hashes, List<string> lBadURLs, List<string> lGoodURLs, Dictionary<string, string> replacements)
    {
      try
      {
        ...
        switch (detector)
        {
          ...
          case "niddel":
            ...
            {
              replacements = Notfication_Niddel_Helper.NiddelBadGuyReturn(lFidoReturnValues, lBadMD5Hashes, lGoodMD5Hashes, lBadURLs, lGoodURLs, replacements);
              replacements = VTReplacements(lFidoReturnValues, lBadMD5Hashes, lGoodMD5Hashes, lBadURLs, lGoodURLs, replacements);
            }
          ...
          case "carbonblack":
            if (lFidoReturnValues.CB == null) return replacements;
          ...
          case "sentinelone":
            if (lFidoReturnValues.SentinelOne == null) return replacements;
            if (lFidoReturnValues.SentinelOne.Alert != null)
            {
              replacements = Notification_SentinelOne_Helper.SentinelOneBadGuyReturn(lFidoReturnValues, lBadMD5Hashes, lGoodMD5Hashes, lBadURLs, lGoodURLs, replacements);
              replacements = VTReplacements(lFidoReturnValues, lBadMD5Hashes, lGoodMD5Hashes, lBadURLs, lGoodURLs, replacements);
            }
            break;
          ...
          case "bit9":
            ...
            {
              if (lFidoReturnValues.Bit9.VTReport == null) return  replacements;
