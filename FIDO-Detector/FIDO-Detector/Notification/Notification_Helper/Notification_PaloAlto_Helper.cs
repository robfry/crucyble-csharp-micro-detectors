...
namespace Fido_Main.Notification.Notification_Helper
{
  class Notification_PaloAlto_Helper
  {
    ...
    {
      if (lFidoReturnValues.PaloAlto.ThreatGRID != null && lFidoReturnValues.PaloAlto.ThreatGRID.ThreatScore > 0)
      {
      ...
      if (lFidoReturnValues.PaloAlto.ThreatGRID != null && lFidoReturnValues.PaloAlto.ThreatGRID.ThreatSeverity > 0)
      {
        if ((lFidoReturnValues.PaloAlto.ThreatGRID.IPThreatInfo != null) && (lFidoReturnValues.PaloAlto.ThreatGRID.IPThreatInfo.Count > 0))
        {
      ...
      if (lFidoReturnValues.PaloAlto.ThreatGRID != null && lFidoReturnValues.PaloAlto.ThreatGRID.ThreatConfidence > 0)
      {
        if ((lFidoReturnValues.PaloAlto.ThreatGRID.IPThreatInfo != null) && (lFidoReturnValues.PaloAlto.ThreatGRID.IPThreatInfo.Count > 0))
        {
      ...
      if (lFidoReturnValues.PaloAlto.ThreatGRID != null && lFidoReturnValues.PaloAlto.ThreatGRID.ThreatIndicators > 0)
      {
        if ((lFidoReturnValues.PaloAlto.ThreatGRID.IPThreatInfo != null) && (lFidoReturnValues.PaloAlto.ThreatGRID.IPThreatInfo.Count > 0))
        {
