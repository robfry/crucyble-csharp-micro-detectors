...
namespace Fido_Main.Director.Director_Helper
{
  static class The_Director_HostDetection
  {
    ...
    //private static string NmapHost(string sIP)
    //{
    //  try
    //  {
        ...
        switch (sNewSource)
        {
          case "landesk":
            ...
            if (lHostInfo[0] != "unknown")
            {
              ...
              lFidoReturnValues.Inventory.Landesk.Patches = SysmgmtLandesk.GetVulns(lFidoReturnValues.Hostname, lQuery[0]);
            ...
            if (lFidoReturnValues.Inventory == null) continue;
          ...
          case "jamf":
            ...
            lFidoReturnValues.Inventory.Jamf = jamf.GetJamf(lFidoReturnValues, !string.IsNullOrEmpty(lFidoReturnValues.Hostname));
            ...
            if (lFidoReturnValues.Inventory.Jamf != null)
            {
              ...
              {
                lFidoReturnValues.Inventory.LastUpdated = lFidoReturnValues.Inventory.Jamf.General.Report_date ?? string.Empty;
              }
              if (lFidoReturnValues.Inventory.Jamf.Hardware != null)
              {
                lFidoReturnValues.Inventory.Domain = lFidoReturnValues.Inventory.Jamf.Hardware.Active_directory_status ?? string.Empty;
                lFidoReturnValues.Inventory.OSName = lFidoReturnValues.Inventory.Jamf.Hardware.Os_name + " " + lFidoReturnValues.Inventory.Jamf.Hardware.Os_version ?? string.Empty;
              }
              if (lFidoReturnValues.Inventory.Jamf.Software != null & lFidoReturnValues.Inventory.Jamf.Software.Running_services != null)
              {
                lFidoReturnValues.Inventory.CBRunning = lFidoReturnValues.Inventory.Jamf.Software.Running_services.Name.Contains("com.carbonblack.daemon").ToString() ?? string.Empty;
                lFidoReturnValues.Inventory.SentRunning = lFidoReturnValues.Inventory.Jamf.Software.Running_services.Name.Contains("com.sentinelone.sentineld").ToString() ?? string.Empty;
              }
            }
          ...
          //    var convertJamf = new Jamf2FidoValues();
          //    lFidoReturnValues.Jamf = convertJamf.Convert(lFidoReturnValues, lHostInfo);
    ...
    //{
    //  var dbValue = new SqLiteDB();
    //  var sDetectors = dbValue.ExecuteScalar(@"select detectors from configs_application where detectors = 'bit9'");
    //  if (sDetectors.Contains("bit9"))
    //  {
    //    return true;
    //  }
    //  else return false;
    ...
    public static FidoReturnValues GetUserInfo(FidoReturnValues lFidoReturnValues)
    {
      ...
      if (!String.IsNullOrEmpty(lFidoReturnValues.Hostname) || !string.IsNullOrEmpty(lFidoReturnValues.Username))
      {
        ...
        //    {
        //      lFidoReturnValues.MachineType = NormalizeOSName(lFidoReturnValues.Inventory.Landesk);
        //    }
        //  }
        //else if ((lFidoReturnValues.Inventory.Jamf != null) && (lFidoReturnValues.Inventory.Jamf.Hardware.Os_name != null))
        //{
        //  lFidoReturnValues.MachineType = lFidoReturnValues.Inventory.Jamf.Hardware.Os_name;
        //}
    ...
    private static string NormalizeOSName(LandeskReturnValues lLandeskReturnValues)
    {
      ...
      else if (lLandeskReturnValues.OSName.ToUpper().Contains("MAC"))
      {
        machineType = "Mac OSX";
      }
      else
